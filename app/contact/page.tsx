...
export const metadata: Metadata = {
  title: "Contact — Rayaan Maredia",
  description: "Get in touch with Rayaan Maredia.",
};
...
const socials = [
  {
    label: "GitHub",
    handle: "@raymaredia28",
    href: "https://github.com/raymaredia28",
    icon: (
  ...
  {
    label: "LinkedIn",
    handle: "Rayaan Maredia",
    href: "https://linkedin.com/in/rayaanmaredia",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
