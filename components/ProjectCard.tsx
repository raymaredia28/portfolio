...
export default function ProjectCard({ title, description, tags, href, repo }: Project) {
  return (
    <div className="group flex flex-col gap-4 rounded-2xl border border-zinc-800 bg-zinc-900 p-6 hover:border-indigo-500/50 hover:bg-zinc-900/80 transition-all duration-300">
      <div className="flex items-start justify-between gap-2">
        <h3 className="text-lg font-semibold text-zinc-50 group-hover:text-indigo-400 transition-colors">
          {title}
        </h3>
